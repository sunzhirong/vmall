...
import com.yslibrary.utils.ViewUtils;


/**
 * Created by fysong on 2020/7/9.
 */

public class HomeBottomTab extends RadioButton {
    ...
    public HomeBottomTab(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (buttonDrawable != null) {
            ...
            if (noLabel) {
                ...
                buttonDrawableLeft = (width - drawableWidth) / 2;
                buttonDrawableTop = getPaddingTop();
        ...
        if (!noLabel) {
            ...
            if (mLabelTextAlign == LABEL_TEXT_ALIGN_BOTTOM) {
                ...
                labelTextY = height - getPaddingBottom() - labelTextHeight;
            } else if (mLabelTextAlign == LABEL_TEXT_ALIGN_RIGHT) {
