...
public class FRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     * @param recycler
     */
    public void adjustSpanSize(FRecyclerView recycler) {
        ...
        if (recycler.getLayoutManager() instanceof GridLayoutManager) {
            ...
            layoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                ...
                public int getSpanSize(int position) {
                    ...
                    if(recycler.getFRcySpanLookUp() != null){
                        int dataPosition  = position - mHeaderViews.size();
                        return recycler.getFRcySpanLookUp().getSpanSize(dataPosition);
                    }
