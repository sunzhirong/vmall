 ...
 **/
public class TBShareCmdDialog extends Dialog {
    @BindView(R.id.riv_tb_cmd_dialog)
    RoundedImageView mRivCover;
    @BindView(R.id.riv_avatar_user_tb_cmd_dialog)
    RoundedImageView mRivAvatar;
    @BindView(R.id.tv_name_user_tb_cmd_dialog)
    TextView mTVName;
    @BindView(R.id.tv_share_tb_cmd_dialog)
    ...
    private TBShareCmdDialog(@NonNull Context context, int themeResId) {
    ...
    private void init(){
        ...
        View view = View.inflate(getContext(), R.layout.dialog_tb_cmd, null);
    ...
    public static class Builder {
        ...
        public TBShareCmdDialog build() {
            TBShareCmdDialog dialog = new TBShareCmdDialog(mContext, R.style.CenterDialog);
